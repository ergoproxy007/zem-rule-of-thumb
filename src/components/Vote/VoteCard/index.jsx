...
export const VoteCard = ({ title, character }) => {
    return (
        <Article className="hero__featured-card">
            ...
            <Section className="featured-card__content">
                <Header>
                    <CustomParagraph className="featured-card__hairline" $fontSize={'1.1em'}>
                        { title }
                    </CustomParagraph>
                    <H2 className="featured-card__title">{ character.name }</H2>
                </Header>
                <Main>
                    <Paragraph className="featured-card__desc">
                        { character.description }
                    </Paragraph>
                    <Paragraph className="featured-card__more-info">
                    ...
                    <Paragraph className="featured-card__cta">
